...
- Enable transitioning a secure zone to insecure mode without making it bogus
  in the process. Changing to 'dnssec-policy none;' also causes CDS and
  CDNSKEY DELETE records to be published, to signal that the entire DS RRset
  at the parent must be removed, as described in RFC 8078. [GL #1750]
